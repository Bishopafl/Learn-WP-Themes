...
<!-- puts a body class within the body element -->
<body <?php body_class(); ?>>
    <header>
        <section class="top-bar">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="search col-xs-3 col-md-5 col-sm-5 col-6 text-right"><?php get_search_form(); ?> </div>
                    </div>
                </div>
        </section>
                ...
                <div class="align">
                    <div class="row">
                        ...
                        <nav class="main-menu col-md-10 text-right">
                            <?php wp_nav_menu( array( 'theme_location' => 'my_mayne_menu' ) ); ?>
                        </nav>
                    </div>
                </div>    
            </div>
